...
const AdminCampaignApprovalScreen: React.FC = () => {
    ...
    return (
        <div className="h-full w-full overflow-y-auto p-4 sm:p-8">
            <div className="max-w-6xl mx-auto">
                <h1 className="text-3xl font-bold mb-2 text-slate-100">Campaign Approvals</h1>
                <p className="text-slate-400 mb-8">Review and approve pending campaigns submitted by users.</p>
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            <div className="grid grid-cols-2 gap-4 mt-4 text-sm">
                                                ...
                                                <div className="bg-slate-700/50 p-3 rounded-lg">
                                                 ...
                                                 <div className="bg-slate-900/70 p-3 rounded-lg col-span-2">
...
export default AdminCampaignApprovalScreen;
